...
class DateHelper {
    ...
    //获取今日的最小时间戳
    getTodayMinTimeStamp() {
        return this.getMinTimeStampByTimeStamp(Date.now());
    }

    //获取今日的最大时间戳
    getTodayMaxTimeStamp() {
        return this.getMaxTimeStampByTimeStamp(Date.now());
    }

    //获取昨日的最小时间戳
    getYesterdayMinTimeStamp() {
        return this.getMinTimeStampByTimeStamp(Date.now()) - oneDayTimeStamp;
    }


    //获取昨日的最大时间戳
    getYesterdayMaxTimeStamp() {
        return this.getMaxTimeStampByTimeStamp(Date.now()) - oneDayTimeStamp;
    }
    ...
    //获取本周最小时间戳
    getCurrentWeekMinTimeStamp() {
        return this.getWeekMinTimeStampByTimeStamp(Date.now());
    }

    //获取本周最大时间戳
    getCurrentWeekMaxTimeStamp() {
        return this.getWeekMaxTimeStampByTimeStamp(Date.now());
    }
    ...
    //获取本月最小时间戳
    getCurrentMonthMinTimeStamp() {
        return this.getMonthMinTimeStampByTimeStamp(Date.now());
    }

    //获取本月最大的时间戳
    getCurrentMonthMaxTimeStamp() {
        return this.getMonthMaxTimeStampByTimeStamp(Date.now());
    }
    ...
    //获取当前时间在今年的第几个星期
    getCurrentDateWeekCountInYear() {
        return this.getWeekCountInYearByTimeStamp(Date.now());
    }

    //获取当前时间在今年的第几个月
    getCurrentDateMonthCountInYear() {
        return this.getMonthCountInYearByTimeStamp(Date.now());
    }

    //获取当前时间在今年的第几个月(中文)
    getCurrentDateMonthCNNameInYear() {
        return `${cnMonthWords[this.getMonthCountInYearByTimeStamp(Date.now())]}月`;
    }
    ...
    //判断两个时间戳是否是同一周
    timeStampIsSameWeek(timeStamp1, timeStamp2) {
        let old_count = parseInt(timeStamp1 / oneDayTimeStamp);
        let now_other = parseInt(timeStamp2 / oneDayTimeStamp);
